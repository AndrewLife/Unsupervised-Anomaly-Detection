...
def rgan_options_parser():
    ...
    parser.add_argument('--AD', type=bool, default=True, help='should we conduct anomaly detection?')
    '''
    ### for gp_rbf
    ...
    parser.add_argument('--latent_dim', type=int, default=1, help='dimensionality \
    ...
    parser.add_argument('--batch_size', type=int, default=609)
    ...
    parser.add_argument('--E_rounds', type=int, default=1, help='number of rounds \
               of encoder training')
    parser.add_argument('--use_time', type=bool, default=True, help='enforce \
    ...
    parser.add_argument('--identifier', type=str, default='Twitter_volume_FB', help='identifier \
            string for output files')
    parser.add_argument('--sub_id', type=str, default='Twitter_volume_FB', help='identifier \
