...
# --- get data, split --- #
data_path = './experiments/data/' + 'Twitter_volume_FB_test.csv'
print('Loading data from', data_path)
settings["eval_single"] = False
settings["eval_an"] = False
samples, labels, index = data_utils.get_data(settings["data"]+'_test', settings["seq_length"], settings["seq_step"],
